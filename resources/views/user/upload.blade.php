		  ...
		  <form id="singleNewCreateForm" action="{{ route('user.userUpdateUpload', ['user' => Auth::user()]) }}" method="POST" enctype="multipart/form-data">
		      ...
		      <div style="padding: 0px;">
		        ...
		        <div style="color: #3F3F3F; margin-top: -15px; font-weight: 500; font-size: 1.1em" class="modal-body">
				  ...
				  <div style="margin-top:3px; margin-bottom: 20px;" class="form-check">
					<input class="form-check-input" type="checkbox" name="outsource" id="outsource" checked=checked>
					<label class="form-check-label" for="outsource">
					    <small style="font-weight: 400; margin-left: 5px; color: #595959;">崁入影片（請參閱在娛見日本 LaughSeeJapan 崁入內容的<a href="/about">指南與守則</a>）</small>
					</label>
				  </div>
