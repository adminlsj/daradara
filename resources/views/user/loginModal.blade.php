<div style="padding:125px" class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="loginModalLabel" aria-hidden="true">
    ...
    <form method="POST" action="{{ route('login') }}">
      ...
      <div style="padding: 10px;" class="modal-content">
        ...
        <div style="color: #3F3F3F; margin-top: -15px; font-size: 1.1em" class="modal-body">
          <span style="font-weight: 500;">訂閱通知將發送至你的電郵地址。</span>
          ...
          <button style="height: 45px; margin-top: 10px;" type="submit" class="btn btn-info" name="submit">登入</button>
