...
<div style="padding-left: 45px; padding-top: 10px; margin-bottom: 8px;">
	@include('video.comment-like-form', ['comment' => $reply])
	<span class="comment-reply-btn" style="color: darkgray; margin-left: 25px; font-size: 0.95em; cursor: pointer; font-weight: 400" data-comment-id="{{ $comment->id }}" data-comment-user="{{ $reply->user->name }}">回覆</span>
</div>