...
<div class="main-content">
	<div style="background-color: #F5F5F5;">
		...
		<div style="background-color: white">
			...
			<div class="explore-tab padding-setup" style="padding: 0px 20px">
				<a href="/rank" class="{{ Request::is('rank') ? 'active' : '' }}" style="margin-right: 5px;">發燒影片</a>
				<a href="/newest" class="{{ Request::is('newest') ? 'active' : '' }}" style="margin-right: 5px;">最新內容</a>
			</div>
			<hr style="margin: 16px 0px 30px 0px; border-color: #e5e5e5;">
		</div>
