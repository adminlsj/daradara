    	...
    	<div style="background-color: #1F1F1F;">
			<div style="background-image: url({{ $watch->imgurH() }}); background-size: 100%; background-repeat: no-repeat; background-position: 50%; filter: blur(30px); z-index: -1; opacity: 0.5; pointer-events: none;">
				<div style="padding: 0px 15px">
					<div style="padding-top: 24px; padding-bottom: 10px; padding-left: 0px; padding-right:30px;" class="row">
						@include('video.introTemp')
					</div>
				</div>
			</div>
			<div style="padding: 0px 15px;">
				<div class="row" style="padding-top: 62px; padding-bottom: 10px; padding-left: 0px; padding-right:30px; position: absolute; top: 0px; width: inherit;">
					@include('video.introTemp')
				</div>
			</div>
