...
@section('head')
    @parent
    <title>{{ $watch->title }} | {{ $watch->genre() }}線上看 | 娛見日本 LaughSeeJapan</title>
    <meta name="title" content="{{ $watch->title }} | {{ $watch->genre() }}線上看 | 娛見日本 LaughSeeJapan">
				    ...
				    <div id="{{ $video->id }}" style="padding: 7px 0px;">
					  <a href="{{ route('video.watch') }}?v={{ $video->id }}" class="row no-gutter">
					    <div style="padding-left: 12px; padding-right: 4px; position: relative;" class="col-xs-6 col-sm-6 col-md-3">
					      ...
					      <img style="position: absolute; width: 46px; height: 46px; bottom:calc(50% - 23px); left: calc(50% - 19px); opacity: 0.6;" src="https://i.imgur.com/WSrfkoQ.png" alt="play button">
					      <img style="position: absolute; width: 46px; height: 46px; bottom:calc(50% - 23px); left: calc(50% - 19px);" src="https://i.imgur.com/BrOdkqU.png" alt="play button">
