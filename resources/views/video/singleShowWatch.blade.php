<div style="background-color: #F9F9F9; box-shadow: 0 4px 8px 0 rgba(0,0,0,0.1); margin-bottom: 15px;">
  ...
  <div style="padding: 0px 25px 25px 25px;">
    ...
    <h5 style="color: dimgray; font-weight: 400; margin-top: 19px; line-height: 20px; margin-bottom: 15px; white-space: pre-wrap;">{{ $video->caption != 'SHOW' && $video->caption != 'HIDE' ? $video->caption : ''}}</h5>
