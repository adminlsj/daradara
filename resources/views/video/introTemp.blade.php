<div class="{{ $watch->genre == 'variety' ? 'col-xs-8 col-xs-offset-2' : 'col-xs-6 col-xs-offset-3' }} col-md-3 col-md-offset-0">
	<img class="lazy" style="width: 100%; height: 100%; border-radius: 3px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.5);" src="{{ $watch->imgurDefaultIntro() }}" data-src="{{ $watch->imgurH() }}" data-srcset="{{ $watch->imgurH() }}" alt="{{ $watch->title }}">
...
<div class="col-xs-12 col-sm-12 col-md-9">
    ...
    <div id="subscribe-panel" class="hidden-md hidden-lg" style="margin-top: -37px; margin-bottom: 47px; margin-right: 5px;">
      @if ($is_subscribed)
