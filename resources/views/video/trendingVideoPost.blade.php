<a href="{{ route('video.trending') }}?v={{ $video->id }}">
    <div class="row">
        ...
        <div class="col-xs-5 col-sm-5 col-md-5" style="padding-left: 0px; padding-right: 0px;">
            <h4 style="margin-top: -1px; font-weight: 500; line-height: 19px; font-size: 1em; overflow: hidden;text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical;">{{ $video->title }}</h4>
