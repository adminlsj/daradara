	...
	<a style="color: inherit; text-decoration: none;" href="{{ route('user.show', [$user]) }}">
	    <div style="position: relative;">
		    ...
		    <div style="background-color: #f5f5f5; padding: 7px 10px; height: 73px">
			    ...
			    <div style="color: darkgray; overflow: hidden;text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 1; -webkit-box-orient: vertical; font-size: 0.85em; margin-top: 3px;">{{ $count }} 個播放清單 • {{ $user->videos->count() }} 部影片</div>
			</div>
		</div>
	</a>
</div>
