<div id="comment-create-form-wrapper" style="padding-bottom: 10px;">
	...
	@else
	  <div data-toggle="modal" data-target="#signUpModal" style="margin-top: 0px; margin-bottom: 25px;">
	    <img class="img-circle" style="width: 40px; height: auto; float:left;" src="https://vdownload.hembed.com/image/icon/user_default_image.jpg?secure=ue9M119kdZxHcZqDPrunLQ==,4855471320">
