<div id="comment-create-form-wrapper" style="padding: 0px 15px;">
	<h4 style="line-height: 23px; font-weight: 400; margin-top:15px; margin-bottom: 10px; color:white; font-size: 1.15em">評論<span style="margin-left: 10px; color: gray">{{ $current->comments()->count() }}</span></h4>
	@if (Auth::check())
