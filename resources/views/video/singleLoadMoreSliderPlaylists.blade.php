<div class="col-xs-6 col-sm-3 col-md-3 hover-opacity-all load-more-wrapper" style="margin-bottom: 9px">
    <div style="position: relative;">
	    <a href="{{ route('video.playlist') }}?list={{ $watch->id }}">
	      <img class="lazy" style="width: 100%; height: 100%;" src="{{ App\Image::$video }}" data-src="{{ $video ? $video->imgurL() : App\Image::$video }}" data-srcset="{{ $video ? $video->imgurL() : App\Image::$video }}" alt="{{ $video ? $video->title : $watch->title }}">
