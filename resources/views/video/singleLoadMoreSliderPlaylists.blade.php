<div class="col-xs-6 col-sm-3 col-md-3 hover-opacity-all load-more-wrapper" style="margin-bottom: 9px">
    <div style="position: relative;">
	    <a href="{{ route('video.playlist') }}?list={{ $video->watch()->id }}">
	      ...
	      <div class="single-load-more-video-wrapper">
	        ...
	        <div style="margin-top: 1px; font-weight: bold; overflow: hidden;text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical;">{{ $video->watch()->title }}</div>
	      </div>
	    </a>
	</div>
</div>