<div class="watch-slider" style="position: relative;">
  ...
  <div class="slider-scroll-right no-select"><i style="vertical-align:middle; font-size: 1em; margin-top: -7px; margin-left: 1px" class="material-icons">arrow_forward_ios</i></div>
</div>