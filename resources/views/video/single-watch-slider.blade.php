<div class="watch-slider" style="position: relative;">
  <div id="custom-scroll-slider">
    @foreach ($selected as $watch)
      <div style="border-radius: 10px; box-shadow: 1px 4px 6px rgba(0,0,0,0.1); display: inline-block; vertical-align: text-top; margin-right: 5px; background-color: #F5F5F5">
