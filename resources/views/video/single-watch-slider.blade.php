...
@else
  <div id="custom-scroll-slider" style="position: relative;">
    @foreach ($selected as $watch)
      ...
      @endif
      @if ($loop->iteration == 8)
        <a class="variety-list-btn" href="{{ route('video.varietyList') }}" style="color:black; width: 58px; height:58px; background-color: white; box-shadow: 1px 4px 6px rgba(0,0,0,0.1); border-radius: 50%; text-align: center; position: absolute; top:calc(50% - 34px); right: 20px">
