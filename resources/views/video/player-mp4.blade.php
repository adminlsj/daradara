...
<video style="width: 100%; height: 100%; max-width: 100% !important; max-height: 100% !important;" id="player" controls crossorigin playsinline data-poster="{{ $video->imgurH() }}" {{ $doujin ? 'loop' : '' }}>
