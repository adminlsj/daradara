		...
		<div id="search-top-watch">
		  <a href="{{ route('video.intro', [$watch->genre, $watch->titleToUrl()]) }}" class="row no-gutter">
		    ...
		    <div class="col-xs-6 col-sm-6 col-md-7">
		      ...
		      <p style="margin-top: 9px; overflow: hidden;text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: {{ $watch->genre == 'variety' ? 2 : 9 }}; -webkit-box-orient: vertical;">{{ $watch->description }}</p>
		    </div>
		  </a>
		</div>
	</div>
