...
<div style="width:78%; margin: 0 auto;" class="mobile-container">
	<div class="row video-no-gutter">
		<div class="col-md-8">
			<div>
		        <h3 class="mobile-margin-top" style="color: black; font-weight: 500; margin-top:15px; margin-bottom: 17px;"><a href="{{ route('blog.category.index', ['genre' => $genre, 'category' => $category]) }}">#{{ $category }}</a> 標籤的影片</h3>
		    </div>
