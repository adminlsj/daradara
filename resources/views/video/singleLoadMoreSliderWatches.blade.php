<div class="col-xs-6 col-sm-3 col-md-3 hover-opacity-all load-more-wrapper" style="position: relative;">
    <a style="text-decoration: none; color: black" href="{{ route('video.playlist') }}?list={{ $watch->id }}">
      <img class="lazy" style="width: 100%; height: 100%;" src="{{ $first->imgur16by9() }}" data-src="{{ $first ? $first->imgurH() : 'https://i.imgur.com/JMcgEkPl.jpg' }}" data-srcset="{{ $first ? $first->imgurH() : 'https://i.imgur.com/JMcgEkPl.jpg' }}" alt="{{ $watch->title }}">
      <span>
