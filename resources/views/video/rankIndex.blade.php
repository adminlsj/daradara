	...
	<div style="background-color: #F5F5F5; padding-top: 20px;">
		...
		<div style="margin-top: 25px; padding: 0px 20px;">
			@if (Request::path() == 'rank')
				<h4><a style="text-decoration: none; color: inherit;" href="{{ route('video.rank') }}">發燒影片</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a style="color: #595959; font-weight: 400" href="{{ route('video.newest') }}">最新內容</a></h4>
			@elseif (Request::path() == 'newest')
				<h4><a style="text-decoration: none; color: inherit;" href="{{ route('video.newest') }}">最新內容</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a style="color: #595959; font-weight: 400" href="{{ route('video.rank') }}">發燒影片</a></h4>
			@endif
