	...
	<div style="background-color: #F5F5F5;">
		...
		<div class="row no-gutter load-more-container">
	      <div class="video-sidebar-wrapper" style="position: relative;">
	          ...
	          <div style="text-align: center;" class="ajax-loading-default"><img style="width: 40px; height: auto; padding-top: 25px; padding-bottom: 50px;" src="https://i.imgur.com/TcZjkZa.gif"/></div>
