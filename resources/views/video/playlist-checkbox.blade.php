<div class="form-check playlist-checkbox-wrapper" style="{{ $first ? '' : '' }}">
  <label class="playlist-checkbox-container" style="position: relative;">
    ...
    <img style="position: absolute; height: 20px; top: 15px; {{ $private ? 'right: 20px;' : 'right: 17px;' }}" src="{{ $private ? 'https://i.imgur.com/JI7zhee.png' : 'https://i.imgur.com/I8xTV0b.png' }}">
  </label>
</div>