<div class="form-check playlist-checkbox-wrapper" style="{{ $first ? '' : '' }}">
  <label class="playlist-checkbox-container" style="position: relative;">
    ...
    <img style="position: absolute; height: 21px; top: 14px; {{ $private ? 'right: 20px;' : 'right: 17px;' }}" src="{{ $private ? 'https://img4.qy0.ru/data/2205/36/save_playlist_private.png' : 'https://img4.qy0.ru/data/2205/36/save_playlist_public.png' }}">
  </label>
</div>