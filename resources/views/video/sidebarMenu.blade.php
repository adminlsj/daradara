<div class="white-theme">
    ...
    @include('video.sidebarItem', ['link' => '/about', 'is_current' => Request::is('about') ? 'active' : '', 'icon' => 'account_tree', 'title' => '娛見日本'])
    @include('video.sidebarItem', ['link' => '/contact', 'is_current' => Request::is('contact') ? 'active' : '', 'icon' => 'mail', 'title' => '與我們聯絡'])
    @include('video.sidebarItem', ['link' => '/terms', 'is_current' => Request::is('terms') ? 'active' : '', 'icon' => 'developer_board', 'title' => '服務條款'])
    @include('video.sidebarItem', ['link' => '/policies', 'is_current' => Request::is('policies') ? 'active' : '', 'icon' => 'policy', 'title' => '社群規範'])
    @include('video.sidebarItem', ['link' => 'copyright', 'is_current' => Request::is('copyright') ? 'active' : '', 'icon' => 'report', 'title' => '版權申訴'])
