<div id="video-playlist-wrapper" style="background-color: #303030;">
  <div style="width: 100%; background-color: #3a3c3f; padding: 10px 15px; height: 79px; position: relative;" class="single-icon-wrapper">
    <img style="object-fit: cover; width:58px; height:58px; border-radius: 50%; float: left; border: 2px solid gray" src="{{ $current->cover == 'https://i.imgur.com/E6mSQA2.png' ? $current->user->avatar->filename : $current->cover }}" alt="{{ $current->title }}">
