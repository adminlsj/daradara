<div id="video-playlist-wrapper">
  <div class="single-icon-wrapper video-playlist-top" style="position: relative;">
    <h4 style="margin-top: 0px; line-height: 20px; margin-bottom: -5px; font-size: 14px; color: white; overflow: hidden;text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; font-weight: bold; padding-right: 50px;">{{ $current->watch->title }}</h4>
