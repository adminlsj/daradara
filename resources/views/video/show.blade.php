	...
	<div class="row video-no-gutter">
		<div class="col-md-8" style="margin-top: 15px;">
			<div class="video-sidebar-wrapper">
		    	...
		    	<div style="background-color: #fafafa" class="fb-comments" data-href="{{ $video->content }}" data-width="auto" data-numposts="5" data-colorscheme="light" data-order-by="social"></div>
