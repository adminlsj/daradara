<a href="{{ route('video.watch') }}?v={{ $video->id }}">
    <div class="row">
        <div class="col-xs-5 col-sm-5 col-md-4 col-lg-3">
            <img style="border-radius: 5px; width: 100%; height: 100%;" src="{{ $video->imgurL() }}" alt="{{ $video->title }}">
        </div>
        <div class="col-xs-5 col-sm-5 col-md-6 col-lg-7" style="padding-left: 0px; padding-right: 0px;">
            ...
            <p style="color: #a9a9a9; margin-top: -8px; margin-bottom: 0px; font-size: 0.8em;">
                ...
                {{ $video->views() }}次 • {{ Carbon\Carbon::parse($video->created_at)->diffForHumans() }}
            </p>
        </div>
