...
<div style="position: relative;" class="video-title-container">
    <span style="position: absolute; top:-24px; right: 7px; background-color: rgba(0,0,0,0.8); color: white; padding: 0px 5px 0 5px; font-size: 0.85em; border-radius: 2px; opacity: 0.9">{{ $video->duration() }}</span>
    <div>
