...
<div style="position: relative;" class="video-title-container">
    <span style="position: absolute; top:-26px; right: 8px; background-color: black; color: white; padding: 1px 5px 0 5px; opacity: 0.7; font-size: 0.85em; border-radius: 2px;">{{ $video->duration() }}</span>
    <div>
