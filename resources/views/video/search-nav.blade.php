<div id="search-nav-wrapper">
	...
	<div id="genre-modal-trigger" class="search-nav no-select {{ Request::get('genre') ? 'active' : '' }}" data-toggle="modal" data-target="#genre-modal">
		...
		<div class="hidden-sm hidden-md hidden-lg" style="border-right: 1px solid #383838; display: inline-block; margin-right: 7px; line-height: 31px;">
	      <a style="color: white; margin-right: 11px; margin-left: 10px; background-color: #373737; padding: 7px 13px 7px 10px; border-radius: 2px; font-weight: bold; text-decoration: none;">
