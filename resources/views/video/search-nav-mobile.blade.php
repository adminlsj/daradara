<div id="search-nav-wrapper" style="background-color: black; padding: 14px 10px 15px 10px; margin-top: 0px; margin-bottom: 5px; border: none;" class="hidden-sm hidden-md hidden-lg hidden-xl">
	...
	<div style="color: #e5e5e5; display: inline-block; font-size: 14px; margin-right: 5px; font-weight: bold; cursor: pointer;" class="search-type-button">
		@if ($type == 'artist')
			<span class="search-type-input">搜索影片</span>
			<img style="width: 12px; margin-top: -3px; margin-left: 3px" src="https://i.imgur.com/qGFVxZb.png">
		@else
