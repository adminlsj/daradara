...
<div class="hidden-sm hidden-md hidden-lg hidden-xl" style="position: absolute; top: 50px; width: 100%; text-align: center; z-index: 99; background: linear-gradient(to bottom, rgba(0,0,0,0.4), rgba(0,0,0,0)) !important; height: 40px; line-height: 40px; padding-left: 4%; padding-right: 4%;">
  <div style="display: inline-block; padding: 0 4%; cursor: pointer;"><a href="{{ route('jav.search') }}?genre=日本AV" style="color: white; text-decoration: none;">日本AV</a></div>
  <div style="display: inline-block; padding: 0 4%; cursor: pointer;"><a href="{{ route('jav.search') }}?genre=素人業餘" style="color: white; text-decoration: none;">素人業餘</a></div>
  <div style="display: inline-block; padding: 0 4%; cursor: pointer;"><a href="{{ route('jav.search') }}?genre=高清無碼" style="color: white; text-decoration: none;">高清無碼</a></div>
...
<form id="hentai-form" action="{{ route('jav.search') }}" method="GET">
  @include('jav.modal-genre', ['genre' => ''])
</form>