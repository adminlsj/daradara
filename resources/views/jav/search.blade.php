...
<form style="overflow-y: hidden;" id="hentai-form" action="{{ route('jav.search') }}" method="GET">

	@include('video.search-nav-desktop')

	@include('video.search-nav-mobile')

	@include('jav.search-genre-modal')
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <div class="modal-body" style="overflow-y: scroll; padding-top: 0px;">
		    ...
		    <h5 style="margin-top: 20px; margin-bottom: 15px; font-weight: bold">衣著服飾</h5>
