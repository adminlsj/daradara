<div class="card-mobile-panel inner">
	<div style="position: relative;">
		...
		<img style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; object-position: top; border-radius: 3px" src="{{ $video->thumbL() }}">
	...
	<div style="padding: 0 3px;">
		<div style="text-decoration: none; color: black;">
			...
			<div class="card-mobile-genre-wrapper" style="margin-left: -2px; padding: 0px; margin-top: -1px;">
				<a href="{{ route('jav.search') }}?query={{ $video->user->name }}" style="font-size: 12px; color: dimgray; margin-left: 2px; display: inline-block; font-weight: normal !important;" class="card-mobile-user">{{ $video->user->name }}</a>
			</div>
		</div>
	</div>
</div>