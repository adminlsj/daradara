  ...
  <div style="width: 80%; background-color: #414143 !important;" class="container-fluid">
    <div style="background-color: #414143 !important;">
      <a href="{{ route('blog.genre.index', ['genre' => $genre]) }}">
	    ...
	    <a style="font-size: 25px; color: white !important; font-weight: 300; line-height: 50px; text-decoration: none; margin-left: -5px;" href="{{ route('blog.genre.index', ['genre' => $genre]) }}">{{ App\Blog::$genres[$genre]['navTitle'] }}</a>
