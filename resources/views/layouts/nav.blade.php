    ...
    <div class="container mobile-container">
        <ul class="nav navbar-nav text-center" >
            ...
            <li class="nav-bottom-share-right">
                <a>
                    @if (!Request::is('/'))
                        <div class="fb-share-button" data-href="{{ route('blog.category.show', ['blog' => $current_blog, 'category' => $blog->category]) }}" data-layout="button_count" data-size="small" data-mobile-iframe="true"><a class="nav-bottom-share-btn" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{ route('blog.show', ['blog' => $current_blog, 'category' => $blog->category]) }}%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">分享貼文</a></div>
                    @else
