<div class="footer">
    ...
    <div style="font-weight: 300; color: white; font-size: 16px; margin-right: 40px;" class="pull-right hidden-sm">API</div>
    <div style="font-weight: 300; color: white; font-size: 16px; margin-right: 40px;" class="pull-right hidden-sm">FAQ</div>
    <div style="font-weight: 300; color: white; font-size: 16px; margin-right: 40px;" class="pull-right hidden-sm">Contact Us</div>
</div>