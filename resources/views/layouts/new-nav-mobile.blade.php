<nav style="border-bottom: 1px solid #e9e9e9; background-color: white; z-index: 999;" class="nav-main-original white-theme-nav-main">
  <div class="container-fluid">
    <div style="height: 50px;">
      ...
      <a id="nav-account-icon" class="pull-right hidden-md hidden-lg nav-item-icon" style="left: 16px;" href="{{ Auth::check() ? route('user.userEditUpload', Auth::user()) : route('login')}}"><i class="material-icons">video_call</i></a>

      <div style="text-align: center">
        <a style="text-decoration: none; line-height: 50px;" href="/">
