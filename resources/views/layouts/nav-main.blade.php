<nav style="box-shadow: 0 9px 9px -9px rgba(0,0,0,0.1); padding: 0px calc(4% - 15px)" class="{{ $theme == 'dark' ? 'dark-theme-nav-main' : 'white-theme-nav-main' }}">
  <div class="container-fluid">
    <div style="height: 50px;">
      ...
      <a class="no-select nav-item-text hidden-sm hidden-md hidden-lg" style="color: #cf2d52; border: 2px solid #cf2d52;" href="{{ Auth::check() ? route('video.subscribes') : route('login') }}">訂閱項目</a>
      ...
      <a id="toggleSearchBar" class="pull-right hidden-sm hidden-md hidden-lg" style="padding: 0px 0px 15px 15px; cursor: pointer; margin-right: 10px;"><i style="font-size: 25px; vertical-align:middle; margin-bottom: -24px; color: #222222" class="material-icons">search</i></a>
    </div>
  </div>
</nav>
