<div style="z-index: 10000 !important; background-color: rgba(30,30,30,0.75); backdrop-filter: blur(45px); -webkit-backdrop-filter: blur(45px); {{ Request::is('*watch*') ? 'display:none;' : '' }}" class="bottom-nav hidden-lg hidden-md white-theme-nav-bottom">
  <a href="/">
    @if (Request::is('/'))
