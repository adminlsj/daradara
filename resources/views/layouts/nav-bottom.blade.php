<div style="{{ Request::is('/') || Request::is('variety') || Request::is('rank') || Request::is('newest') ? 'display:none' : '' }}" class="bottom-nav hidden-lg hidden-md {{ $theme == 'dark' ? 'dark-theme-nav-bottom' : 'white-theme-nav-bottom' }}">
