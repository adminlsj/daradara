<div style="z-index: 10000 !important; background-color: rgba(0,0,0,0.5); backdrop-filter: blur(45px); -webkit-backdrop-filter: blur(45px); {{ Request::is('*watch*') ? 'display:none;' : '' }}" class="bottom-nav hidden-lg hidden-md white-theme-nav-bottom">
  <a href="/">
    @if (Request::is('/'))
