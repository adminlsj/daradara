...
@section('nav')
	...
	<div id="main-nav-home-mobile" style="z-index: 10000 !important; overflow-x: hidden; background: black !important; background-color: black !important; transition: height 0.3s, background-color 0.4s, backdrop-filter 0.4s, -webkit-backdrop-filter 0.4s, top 0.4s;" class="hidden-sm hidden-md hidden-lg">
