	...
	<div id="main-nav-home" style="z-index: 10000; padding:0; padding-top: 3px; height: 48px; line-height: 40px; position: absolute; background-image: none; border-bottom: 1px solid #383838; margin-bottom: 0px; background-color: #212121;" class="hidden-sm hidden-md hidden-lg">
	  ...
	  <div style="padding: 0 10px; margin-bottom: -10px;">
	    ...
	    <form id="search-form" style="display: inline-block; margin-left: 8px; width: calc(100% - 115px); position: relative;">
		    <div id="nav-search-btn" class="search-btn"><img style="margin-top: -9px; margin-left: 5px;" height="20" src="https://i.imgur.com/fblmkmT.png"></div>
...
<form id="hentai-form" action="{{ route('home.search') }}" method="GET">
	...
	<div id="home-rows-wrapper" class="search-rows-wrapper" style="position: relative;">
		...
		<div class="hidden-sm hidden-md hidden-lg" style="text-align: center; padding-top: 14px; {{ $videos->lastPage() == 1 ? 'margin-bottom: 24px' : 'margin-bottom: -22px'}}">
