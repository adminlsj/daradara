...
<form id="hentai-form" action="{{ route('home.search') }}" method="GET">
	...
	<div id="home-rows-wrapper" class="search-rows-wrapper" style="position: relative; padding: 0 5px; {{ $is_mobile ? 'background-color: #202020' : '' }}">
...
<div class="{{ $is_mobile ? 'hidden' : '' }}" style="background-color: #212121; margin-top: 50px;">
