<nav class="nav-main-original {{ $theme == 'dark' ? 'dark-theme-nav-main' : 'white-theme-nav-main' }}">
  <div class="container-fluid">
    <div style="height: 50px;">
      ...
      <form id="search-form" class="hidden-xs pull-right" style="text-align: left; width: 62%; margin-top: 10px;" action="{{ route('video.search') }}" method="GET">
          <input name="query" style="box-shadow: none; border: 1px solid #d1d1d1; background-color: white; font-size: 1em; width: 62%; border-top-left-radius: 2px; border-bottom-left-radius: 2px; height: 31px; padding-left: 10px;" type="text" value="{{ request('query') }}" placeholder="搜索">
