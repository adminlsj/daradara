<nav class="nav-main-original {{ $theme == 'dark' ? 'dark-theme-nav-main' : 'white-theme-nav-main' }}">
  <div class="container-fluid">
    <div style="height: 50px;">
      <i style="vertical-align:middle; margin-left: 10px; margin-right:25px; font-size: 1.8em; margin-top: 8px" class="material-icons hidden-xs hidden-sm">menu</i>

      <a href="/">
          <img src="https://i.imgur.com/{{ $theme == 'dark' ? 'xSMGFWh' : 'M8tqx5K.png'}}.png" style="margin-top: 13px; margin-left: -5px;" height="26" alt="娛見日本 LaughSeeJapan">
      </a>
