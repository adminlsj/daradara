<nav style="border-bottom: 1px solid #e9e9e9; background-color: white; z-index: 1000" class="nav-main-original white-theme-nav-main">
  <div class="container-fluid">
    <div style="height: 50px;">
      ...
      <form id="search-form" class="hidden-xs hidden-sm pull-left" style="width: 70%; margin-top: 5px; margin-left:152px; margin-right: -400px; position: relative;" action="{{ route('video.searchGoogle') }}" method="GET">
          <i style="position: absolute; top: 8px; left: 17px; color: dimgray" class="material-icons">search</i>
          <input name="q" style="box-shadow: none; border: 1px solid #e8eaed; background-color: #e8eaed; font-size: 1.1em; width: 62%; border-radius: 7px; height: 40px; padding-left: 53px; color: #222222; padding-bottom: 2.5px;" type="text" value="{{ request('q') }}" placeholder="搜索">
      </form>
