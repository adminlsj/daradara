<nav style="border-bottom: 1px solid #e9e9e9; background-color: white; z-index: 999; padding: 0px 5px" class="white-theme-nav-main main">
  <div class="container-fluid">
    <div style="height: 50px;">
      ...
      <form id="search-form" class="hidden-xs hidden-sm pull-left" style="width: 50%; margin-top: 5px; left:370px; position: absolute;" action="{{ route('video.search') }}" method="GET">
          ...
          <input name="query" style="box-shadow: none; border: 1px solid #e8eaed; background-color: #e8eaed; font-size: 1.1em;border-radius: 7px; height: 40px; padding-left: 53px; color: #222222; padding-bottom: 2px; font-weight: 500;" type="text" value="{{ request('query') }}" placeholder="搜索">
      </form>
