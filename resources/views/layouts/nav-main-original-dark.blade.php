  ...
  <div class="container-fluid" id="hentai-filter-nav">
    <div style="height: 50px;">
      <div class="pull-left" style="color: #d1d1d1">
        <div style="border: 1px solid rgba(58,60,63,.85); line-height: 48px; width: 16vw; text-align: center; display: inline-block; margin-right: 4px"><span style="vertical-align: middle; color: darkgray;" class="material-icons">loyalty</span><span class="hidden-xs" style="margin-left: 10px">標籤</span></div>
