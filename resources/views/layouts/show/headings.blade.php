<div class="headings">
    ...
    <div class="short-des">
        ...
        <div class="info">
            ...
            <div class="genres">
                <p>類別: </p>
                <ul>
                    <li><a href="" style="background-color:#f44336">搞笑</a></li>
                    <li><a href="" style="background-color:pink">戀愛</a></li>
                    <li><a href="" style="background-color:green">日常</a></li>
                    <li><a href="" style="background-color:lightskyblue">異世界</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="button-groups">
        ...
        <button>
            ...
            <span class="tooltiptext">點贊</span>
        </button>
        <button>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                <path
            ...
            <span class="tooltiptext">評論</span>
        </button>
    </div>
</div>