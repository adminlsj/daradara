<div class="col-xs-4 hover-opacity-all" style="padding: 0px 4px;">
	<div style="border-radius: 10px; box-shadow: 1px 4px 6px rgba(0,0,0,0.1); background-color: #F5F5F5;">
	  <a style="text-decoration: none; color: black;" href="{{ $link }}">
	    ...
	    <div style="height: 45px; padding: 2px 15px;">
	      <h4 style="line-height: 19px; font-size: 1em; font-weight: 450; color: #222222">{{ $genre }}</h4>
	    </div>
	  </a>
    </div>
</div>