...
<div class="nav-bottom-padding">
	...
	<div class="hidden-sm hidden-md hidden-lg" style="position: relative;">
		<img style="width: 100%; -webkit-mask-image:-webkit-gradient(linear, left top, left bottom, from(rgba(0,0,0,1)), to(rgba(0,0,0,0)));" src="https://i.imgur.com/rEe2SNO.png">
	...
	<div id="home-rows-wrapper" style="position: relative;">
		@foreach ($rows as $title => $data)
			...
			<div style="position: relative;">
				<div class="hidden-xs hidden-sm no-select navigate-before-btn" style="background-color: rgba(0, 0, 0, .7); height: 100%; width: calc(4% - 2px); position: absolute; top: 0; left: 0; cursor: pointer; z-index: 1; display: none;">
					...
					@foreach ($data['videos'] as $video)
						<a style="text-decoration: none;" href="{{ route('video.watch') }}?v={{ $video->id }}">
							<div class="home-rows-videos-div" style="position: relative; display: inline-block;">
								<img src="{{ $video->cover }}">
						        <div class="home-rows-videos-title" style="position:absolute; bottom:0; left:0; white-space: initial; overflow: hidden;text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; color: white; width: 100%; padding: 3px 3px; background: linear-gradient(to bottom, transparent 0%, black 120%); font-size: 14px">{{ $video->title }}</div>
					        </div>
						</a>
					@endforeach
				</div>
				<div class="hidden-xs hidden-sm no-select navigate-next-btn" style="background-color: rgba(0, 0, 0, .7); height: 100%; width: calc(4% + 2px); position: absolute; top: 0; right: 0; cursor: pointer; z-index: 1">
	...
	<!--<div style="margin: 0 4%; padding-top: 5px; padding-bottom: 50px;">
		<script type="application/javascript">
		    var ad_idzone = "4011908",
		    ad_width = "900",
		    ad_height = "250"
		</script>
		<script type="application/javascript" src="https://a.realsrv.com/ads.js"></script>
		<noscript>
		    <iframe src="https://syndication.realsrv.com/ads-iframe-display.php?idzone=4011908&output=noscript&type=900x250" width="900" height="250" scrolling="no" marginwidth="0" marginheight="0" frameborder="0"></iframe>
		</noscript>
