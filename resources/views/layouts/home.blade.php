...
<div class="nav-bottom-padding">
	...
	<div class="hidden-sm hidden-md hidden-lg" style="position: relative;">
		<div style="position: relative;">
			<img style="width: 120%;" src="https://img4.qy0.ru/data/2197/80/home_poster_background.jpg">
			...
			<div style="position: absolute; top: 100px; left: 50%; -webkit-transform: translateX(-50%); transform: translateX(-50%); width: 88%; height: 74%;">
				...
				<div style="position: absolute; left: 50%; -webkit-transform: translateX(-50%); transform: translateX(-50%); width: 96%; bottom: 3%; text-align: center; color: white">
					...
					<div style="margin-top: 15px; width: 100%">
						<a href="{{ route('video.watch') }}?v={{ $random->id }}" class="hover-opacity-all home-banner-btn home-banner-play-btn play-btn" target="_blank" style="cursor: pointer; font-size: 14px; text-decoration: none; color: black;">
							<div style="display: inline-block; margin-top: 5px; width: 46%; margin-right: 5px; background-color: white; padding-top: 7px; padding-bottom: 5px; border-radius: 5px;">
						...
						<a href="{{ route('video.watch') }}?v={{ $random->id }}" class="hover-opacity-all home-banner-btn home-banner-info-btn" style="cursor: pointer; font-size: 14px; text-decoration: none; color: white;">
							<div style="display: inline-block; margin-top: 5px; width: 46%; background-color: rgba(109, 109, 110, 0.8); margin-left: 5px; padding-top: 8px; padding-bottom: 7px; border-radius: 5px;">
