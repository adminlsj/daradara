	...
	<div id="home-rows-wrapper" style="position: relative;">
		@foreach ($rows as $title => $data)
			...
			<div style="position: relative;">
				...
				<div class="hidden-xs hidden-sm no-select navigate-next-btn" style="background-color: rgba(0, 0, 0, .7); height: 100%; width: calc(4% + 1px); position: absolute; top: 0; right: 0; cursor: pointer; z-index: 1">
