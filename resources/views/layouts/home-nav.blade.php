<div style="position:absolute; top: 6%; right: 10%;z-index: 999" class="home-nav hidden-xs">
    @guest
    ...
    @else
        ...
        <a href="{{ route('user.edit', ['user' => auth()->user()]) }}" style="padding-left: 10px; padding-right: 10px">
...
<nav style="z-index:99999999" class="home-nav-scroll-show navbar navbar-default navbar-fixed-top">
