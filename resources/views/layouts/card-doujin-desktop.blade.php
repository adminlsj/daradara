	...
	<div style="position: relative;">
		...
		<div style="position: absolute; right: -2px; bottom: -3px;">
			@if ($video->duration != null)
			    <div class="card-mobile-duration" style="color: white; font-size: 10px; background-color: rgba(0, 0, 0, 0.6); padding: 0px 3px; line-height: 15px; margin-top: 6px; margin-right: 4px">
