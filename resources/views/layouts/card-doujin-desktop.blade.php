<div class="card-mobile-panel inner">
	<div style="position: relative;">
		...
		<div style="position: absolute; left: -2px; bottom: -3px;">
		...
		<div style="position: absolute; left: 3px; top: 2px;">
			<div class="card-mobile-duration" style="color: white; font-size: 10px; background-color: rgba(0, 0, 0, 0.6); padding: 0px 3px; line-height: 18px">
		    	{{ $video->views() }}次
		    </div>
		</div>
    </div>
