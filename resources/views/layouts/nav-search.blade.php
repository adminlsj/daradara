<nav style="z-index: 1000; background-color: #e9e9e9; height: 50px; {{ request('query') != '' ? '' : 'display: none'}}" id="searchBar" class="hidden-md hidden-lg">
  <div style="background-color: #e9e9e9;">
    ...
    <form id="search-form" style="background-color: #e9e9e9;" action="{{ route('video.searchGoogle') }}" method="GET">
      ...
      <input id="q" name="q" style="vertical-align:middle; margin-bottom: -28px; background-color: #e9e9e9; box-shadow: none; border-bottom: none; font-weight: bold;" type="text" value="{{ request('query') }}" placeholder="搜索">
