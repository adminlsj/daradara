...
<div><span style="font-weight: 600">remove: </span><a href="{{ route('tag.remove') }}?v={{ $video_id }}&tags[]={{ $added_tags }}" target="_blank">{{ route('tag.remove') }}?v={{ $video_id }}&tags[]={{ $added_tags }}</a></div>
<div><span style="font-weight: 600">include: </span><a href="{{ route('tag.include') }}?v={{ $video_id }}&tags[]={{ $added_tags }}" target="_blank">{{ route('tag.include') }}?v={{ $video_id }}&tags[]={{ $added_tags }}</a></div>
