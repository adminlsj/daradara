...
@section('content')
<form id="hentai-form" action="{{ route('company.search') }}" method="GET">
	<div class="flex-center-wrapper home-wrapper">
		<div class="flex-center-content flex-column" style="margin-top: 100px;">
			<div style="font-size: 2.8rem; color: rgb(100,115,128); font-weight: 800;">搜尋製作公司</div>
					...
					<div class="media-wrap">
						@foreach ($results as $company)
							<div class="media-card">
								<a class="cover" href="{{ route('company.show', ['company' => $company->id, 'title' => $company->getName($chinese)]) }}">
