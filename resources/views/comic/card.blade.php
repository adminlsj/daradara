<div class="comic-rows-videos-div" style="position: relative; display: inline-block; margin-bottom: 0px; vertical-align: top;">
  ...
  <img class="lazy" style="border-top-left-radius: 5px; border-top-right-radius: 5px;" src="https://img4.qy0.ru/data/2205/36/0n3iJ9Ol.jpg" data-srcset="{{ $comic->nhentai_id ? 'https://t.nhentai.net/galleries/'.$comic->galleries_id.'/cover.'.$comic->extension : $comic->prefix.'000.'.$comic->extension }}">
