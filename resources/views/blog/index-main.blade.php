				...
				@foreach ($caro_blogs as $blog)
					<div class="embed-responsive embed-responsive-4by3">
						<a href="{{ route('blog.show', ['blog' => $blog->id]) }}">
							<img class="embed-responsive-item border-radius-2" src="https://s3.amazonaws.com/twobayjobs/blogImgs/originals/{{ $blog->id }}/{{ $blog->blogImgs->first()->filename }}" alt="日本旅行推薦">
		...
		@foreach ($blogs as $blog)
			<div class="col-md-6 col-ms-12">
				<div class="card">
					<div class="embed-responsive embed-responsive-4by3">
		                <a href="{{ route('blog.show', ['blog' => $blog->id]) }}">
		                	<img class="embed-responsive-item" src="https://s3.amazonaws.com/twobayjobs/blogImgs/thumbnails/{{ $blog->id }}/{{ $blog->blogImgs->sortby('created_at')->first()->filename }}" alt="日本旅行推薦">
		                </a>
	                </div>
