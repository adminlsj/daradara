<div id="main-nav-home-mobile" style="z-index: 10000 !important; position: fixed !important; overflow-x: hidden; background: none; -webkit-backdrop-filter: blur(20px); backdrop-filter: blur(20px); transition: height 0.3s;" class="hidden-sm hidden-md hidden-lg">
