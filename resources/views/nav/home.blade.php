<div id="main-nav" style="z-index: 10000 !important; position: fixed !important; height: 50px !important; overflow-x: hidden; background: none;" class="main-nav-home main-nav-mobile hidden-sm hidden-md hidden-lg">
...
<div class="hidden-sm hidden-md hidden-lg hidden-xl video-buttons-wrapper desktop-inline-mobile-block hide-scrollbar" style="position: absolute; top: 40px; width: 100%; text-align: center; z-index: 99; height: 40px; line-height: 40px; overflow-y: hidden; padding: 0px 4%;">
  ...
  <div class="home-genre-tabs-wrapper"><a href="https://cherrytale.ero-labs.com/lp/landing_page_zh.html" class="home-genre-tabs" style="text-decoration: none;" target="_blank">無碼黃油</a></div>
