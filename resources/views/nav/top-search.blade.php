<nav style="border-bottom: 1px solid #d9d9d9; background-color: #e9e9e9; height: 50px; {{ request('query') != '' ? '' : 'display: none'}}" id="searchBar" class="">
  <div style="background-color: #e9e9e9;">
    ...
    <form id="search-form" style="background-color: #e9e9e9;" action="{{ route('home.search') }}" method="GET">
      ...
      <input id="query" name="query" style="vertical-align:middle; margin-bottom: -27px; background-color: #e9e9e9; box-shadow: none; border-bottom: none;" type="text" value="{{ request('query') }}" placeholder="搜索">
