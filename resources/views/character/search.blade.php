					...
					<div class="media-wrap">
						@foreach ($results as $character)
							<div class="media-card">
								<a class="cover" href="{{ route('character.show', ['character' => $character->id, 'title' => $character->getTitle($chinese)]) }}">
									<img src="{{ $character->photo_cover }}" alt="">
								</a>
								<a style="text-decoration: none" href="{{ route('character.show', ['character' => $character->id, 'title' => $character->getTitle($chinese)]) }}">{{ $character->getTitle($chinese) }}
								</a>
							</div>
						@endforeach
					</div>
