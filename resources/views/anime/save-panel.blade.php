                ...
                <div class="modal-body" style="padding: 0px; text-align: left; background-color: white; border-radius: 3px 3px 0 0 !important; padding-bottom: 50px;">
                    ...
                    <div class="add-to-list-content" style="color: rgba(92,114,138); min-height: 285px;">
                        ...
                        <div class="form-group" style="width: 20%">
                            ...
                            <a style="color: rgba(92, 114, 138); z-index: 100;" href="{{ Auth::check() ? route('user.animelist', ['user' => Auth::user(), 'name' => Auth::user()->name]) : route('login') }}" target="_blank">
                                <div style="margin-bottom: 1px;">
                                    <div style="float: left; width: 24px; display: inline-block; padding-left: 0px;">
                                        <i class="material-icons-sharp" style="font-size: 17px; vertical-align: middle; margin-top: -1px; margin-left: -2px; color: #d5d8dc">add_box</i>
                                    </div>
                                    <div style="display: inline-block; width: calc(100% - 24px);">
                                        <label style="font-size: 1.2rem; font-weight: 400; margin-top: -1px; cursor: pointer;" class="no-select">新增播放清單</label>
                                    </div>
                                </div>
                            </a>
