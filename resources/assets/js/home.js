$(document).on("click", ".load-home-tag-videos", function(e) {
    ...
    $('.ajax-' + genre + '-loading').html('<img style="width: 40px; height: auto; margin: 0; position: absolute; top: calc(50% - 8px); left: 50%; transform: translate(-50%, -50%);" src="https://i.imgur.com/TcZjkZa.gif"/>');
