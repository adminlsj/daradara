...
class UpdateXvideosErrors extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'hanime1:update-xvideoserrors';
     ...
     * @var string
     */
    protected $description = 'Update error hentai with xvideos as source';
    ...
    {
        Log::info('Xvideos errors update started...');

        $videos = Video::where('sd', 'ilike', '%xvideos%')->where('foreign_sd', 'ilike', '%"error": "https://www.xvideos.com/%')->orderBy('id', 'desc')->get();
