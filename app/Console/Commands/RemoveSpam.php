...
class RemoveSpam extends Command
{
    ...
    public function handle()
    {
        ...
        User::whereIn('email', ['junheipou@gmail.com', 'caigueikim149@gmail.com', 'honggoujishenme52@gmail.com'])->where('created_at', '>=', Carbon::now()->subDay())->delete();
