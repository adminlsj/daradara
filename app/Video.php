...
class Video extends Model
{
    ...
    public static $storyline = [
        '純愛', '戀愛喜劇', '後宮', '公眾場合', 'NTR', '精神控制', '藥物', '痴漢', '阿嘿顏', '精神崩潰', '鬼畜', 'BDSM', '綑綁', '眼罩', '調教', '肉便器', '強制', '逆強制', '女王樣', '攝影', '性轉換', '百合', '耽美', '異世界', '怪獸', '世界末日', '番劇', '1080p', '無碼'
    ];

    public static $position = [
        '手交', '指交', '乳交', '肛交', '腳交', '口交', '口爆', '吞精', '爆精', '舔蛋蛋', '舔穴', '69', '自慰', '毒龍鑽', '腋下', '內射', '顏射', '3P', '群交', '雙洞齊下', '懷孕', '噴奶', '放尿', '顏面騎乘', '女陰摩擦', '車震', '性玩具', '觸手', '頸手枷'
    ];
