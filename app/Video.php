...
class Video extends Model
{
    ...
    protected $fillable = [
        'id', 'user_id', 'playlist_id', 'comic_id', 'title', 'caption', 'tags', 'sd', 'qualities', 'downloads', 'imgur', 'current_views', 'week_views', 'month_views', 'views', 'outsource', 'foreign_sd', 'data', 'created_at', 'uploaded_at', 'duration', 'translations', 'cover', 'tags_array', 'uncover', 'has_torrent', 'artist', 'genre', 'searchtext'
    ];
    ...
    public static $profession = [
        'JK', '處女', '御姐', '熟女', '人妻', '老師', '女醫護士', 'OL', '大小姐', '偶像', '女僕', '巫女', '修女', '風俗娘', '公主', '女戰士', '魔法少女', '異種族', '妖精', '魔物娘', '獸娘', '碧池', '痴女', '雌小鬼', '不良少女', '傲嬌', '病嬌', '無口', '偽娘', '扶他'
    ];

    public static $appearance = [
        '短髮', '馬尾', '雙馬尾', '巨乳', '貧乳', '黑皮膚', '眼鏡娘', '獸耳', '美人痣', '肌肉女', '白虎', '陰毛', '腋毛', '大屌', '水手服', '體操服', '泳裝', '比基尼', '和服', '兔女郎', '圍裙', '啦啦隊', '旗袍', '絲襪', '吊襪帶', '熱褲', '迷你裙', '性感內衣', '丁字褲', '高跟鞋', '淫紋'
    ];

    public static $storyline = [
        '純愛', '戀愛喜劇', '後宮', '開大車', '公眾場合', 'NTR', '精神控制', '藥物', '痴漢', '阿嘿顏', '精神崩潰', '獵奇', 'BDSM', '綑綁', '眼罩', '項圈', '調教', '異物插入', '肉便器', '胃凸', '強制', '輪姦', '凌辱', '性暴力', '逆強制', '女王樣', '母女丼', '姐妹丼', '出軌', '攝影', '睡眠姦', '機械姦', '性轉換', '百合', '耽美', '異世界', '怪獸', '世界末日'
    ];

    public static $position = [
        '手交', '指交', '乳交', '肛交', '腳交', '拳交', '3P', '群交', '口交', '口爆', '吞精', '舔蛋蛋', '舔穴', '69', '自慰', '腋交', '舔腋下', '內射', '顏射', '雙洞齊下', '懷孕', '噴奶', '放尿', '排便', '顏面騎乘', '車震', '性玩具', '毒龍鑽', '觸手', '頸手枷', '著衣'
    ];

    public static $selected_tags = [
        '姐', '妹', '母', '人妻', '青梅竹馬', '御姐', '熟女', 'JK', '運動少女', '大小姐', '老師', '女醫護士', '女僕', '巫女', '修女', '偶像', 'OL', '風俗娘', '公主', '女騎士', '魔法少女', '妖精', '魔物娘', '獸娘', '貧乳', '黑皮膚', '眼鏡娘', '泳裝', '圍裙', '黑絲襪', '和服', '獸耳', '處女', '不良少女', '傲嬌', '病嬌', '偽娘', '扶他', '肛交', '腳交', '觸手', '群交', '肉便器', '後宮', '近親', '師生', 'NTR', '懷孕', '噴奶', '放尿', '排便', '精神控制', '藥物', '痴漢', '阿嘿顏', '精神崩潰', '鬼畜', 'BDSM', '強制', '逆強制', '痴女', '女王樣', '百合', '耽美', '性轉換', '異世界', '異種族', '純愛', '戀愛喜劇', '世界末日', '1080p', '無碼', '3D', '同人', 'Cosplay', '項圈', '腋交', '舔腋下', '無口', '淫紋', '異物插入', '姐妹丼', '同事'
    ];
    ...
    public static $all_tag = [
        '近親', '姐', '妹', '母', '女兒', '師生', '情侶', '青梅竹馬', 'JK', '處女', '御姐', '熟女', '人妻', '老師', '女醫護士', 'OL', '大小姐', '偶像', '女僕', '巫女', '修女', '風俗娘', '公主', '女戰士', '魔法少女', '異種族', '妖精', '魔物娘', '獸娘', '碧池', '痴女', '不良少女', '傲嬌', '病嬌', '偽娘', '扶他', '短髮', '馬尾', '雙馬尾', '巨乳', '貧乳', '黑皮膚', '眼鏡娘', '獸耳', '美人痣', '肌肉女', '白虎', '大屌', '水手服', '體操服', '泳裝', '比基尼', '和服', '兔女郎', '圍裙', '啦啦隊', '旗袍', '絲襪', '吊襪帶', '熱褲', '迷你裙', '性感內衣', '丁字褲', '高跟鞋', '純愛', '戀愛喜劇', '後宮', '開大車', '公眾場合', 'NTR', '精神控制', '藥物', '痴漢', '阿嘿顏', '精神崩潰', '獵奇', 'BDSM', '綑綁', '眼罩', '調教', '肉便器', '胃凸', '強制', '逆強制', '女王樣', '母女丼', '凌辱', '出軌', '攝影', '性轉換', '百合', '耽美', '異世界', '怪獸', '世界末日', '手交', '指交', '乳交', '肛交', '腳交', '拳交', '3P', '群交', '口交', '口爆', '吞精', '舔蛋蛋', '舔穴', '69', '自慰', '毒龍鑽', '內射', '顏射', '雙洞齊下', '懷孕', '噴奶', '放尿', '顏面騎乘', '車震', '性玩具', '觸手', '頸手枷', '項圈', '排便', '腋毛', '腋交', '舔腋下', '無口', '淫紋', '異物插入', '姐妹丼', '黑絲', '過膝襪', '運動裝', '肉絲', '絲襪', '眼鏡娘', '獸耳', '漁網', '水着', '校服', '旗袍', '婚紗', '女僕', '和服', '吊帶襪', '兔女郎', 'Cosplay', '黑肉', '長身', '軟體', '貧乳', '蘿莉', '美腿', '美尻', '紋身', '短髮', '白虎', '熟女', '巨乳', '少女', '顏射', '腳交', '肛交', '痙攣', '潮吹', '深喉', '接吻', '口爆', '口交', '乳交', '中出', '露出', '調教', '綑綁', '瞬間插入', '直接開啪', '痴漢', '痴女', '男M', '泥醉', '泡姬', '母乳', '放尿', '按摩', '強姦', '多P', '刑具', '凌辱', '一日十回', '3P', '女同', '黑人', '醜男', '誘惑', '童貞', '時間停止', '復仇', '年齡差', '巨漢', '媚藥', '夫目前犯', '出軌', '催眠', '偷拍', '不倫', '下雨天', 'NTR', '風俗娘', '醫生', '逃犯', '護士', '老師', '空姐', '球隊經理', '未亡人', '搜查官', '情侶', '家政婦', '家庭教師', '偶像', '人妻', '主播', 'OL', '魔鏡號', '電車', '處女', '監獄', '溫泉', '洗浴場', '泳池', '汽車', '廁所', '學校', '圖書館', '健身房', '便利店', '更衣間', '中文字幕', '素人', '錄像', '處女作/引退作', '綜藝', '節日主題', '感謝祭', '4小時以上', '同事', '著衣', '性暴力', '雌小鬼', '陰毛', '睡眠姦', '機械姦', '輪姦', 'ASMR'
    ];
    ...
    public static $body = [
        '黑肉', '長身', '軟體', '貧乳', '蘿莉', '美腿', '美尻', '紋身', '短髮', '白虎', '熟女', '巨乳', '少女'
    ];

    public static $sexpose = [
        '顏射', '腳交', '肛交', '痙攣', '潮吹', '深喉', '接吻', '口爆', '口交', '乳交', '中出'
    ];

    public static $fantasy = [
        '露出', '輪姦', '調教', '綑綁', '瞬間插入', '直接開啪', '痴漢', '痴女', '男M', '泥醉', '泡姬', '母乳', '放尿', '按摩', '強姦', '多P', '刑具', '凌辱', '一日十回', '3P', '女同'
    ];

    public static $storysetting = [
        '黑人', '醜男', '誘惑', '童貞', '時間停止', '復仇', '年齡差', '巨漢', '媚藥', '夫目前犯', '出軌', '催眠', '偷拍', '不倫', '下雨天', 'NTR'
    ];

    public static $character = [
        '風俗娘', '醫生', '逃犯', '護士', '老師', '空姐', '球隊經理', '未亡人', '搜查官', '近親相姦', '情侶', '家政婦', '家庭教師', '偶像', '人妻', '主播', 'OL'
    ];

    public static $location = [
        '魔鏡號', '電車', '處女', '監獄', '溫泉', '洗浴場', '泳池', '汽車', '廁所', '學校', '圖書館', '健身房', '便利店', '更衣間'
    ];

    public static $others = [
        '中文字幕', '素人', '錄像', '處女作/引退作', '綜藝', '節日主題', '感謝祭', '4小時以上'
    ];
}
