...
class Video extends Model
{
    ...
    public static $all_tag = [
        '近親', '姐', '妹', '母', '師生', '情侶', '青梅竹馬', 'JK', '處女', '御姐', '熟女', '人妻', '老師', '女醫護士', 'OL', '大小姐', '偶像', '女僕', '巫女', '修女', '風俗娘', '公主', '女戰士', '魔法少女', '異種族', '妖精', '魔物娘', '獸娘', '碧池', '痴女', '不良少女', '傲嬌', '病嬌', '偽娘', '扶他', '短髮', '長髮', '馬尾', '雙馬尾', '巨乳', '貧乳', '黑皮膚', '眼鏡娘', '獸耳', '美人痣', '肌肉女', '白虎', '大屌', '水手服', '體操服', '泳裝', '比基尼', '和服', '兔女郎', '圍裙', '絲襪', '吊襪帶', '熱褲', '迷你裙', '性感內衣', '丁字褲', '高跟鞋', '純愛', '戀愛喜劇', '後宮', '公眾場合', 'NTR', '精神控制', '藥物', '痴漢', '阿嘿顏', '精神崩潰', '鬼畜', 'BDSM', '綑綁', '眼罩', '調教', '肉便器', '胃凸', '強制', '逆強制', '女王樣', '母女丼', '攝影', '性轉換', '百合', '耽美', '異世界', '怪獸', '世界末日', '無碼', '手交', '指交', '乳交', '肛交', '腳交', '拳交', '口交', '口爆', '吞精', '爆精', '舔蛋蛋', '舔穴', '69', '自慰', '毒龍鑽', '腋下', '內射', '顏射', '3P', '群交', '雙洞齊下', '懷孕', '噴奶', '放尿', '顏面騎乘', '女陰摩擦', '車震', '性玩具', '觸手', '頸手枷'
    ];
