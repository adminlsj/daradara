...
class Video extends Model
{
    ...
    public static $selected_tags = [
        '3D', 'JK', '御姐', '人妻', '熟女', '大小姐', '公主', '傲嬌', '痴女', '處女', '眼鏡娘', '黑皮膚', '歐尼醬', '老師', '女OL', '痴漢', '貧乳', '腳交', '肛交', '毒龍鑽', '腋下', '群交', '後宮', '親子丼', '阿嘿顏', '援交', 'BDSM', '綑綁', '觸手', '強制', '鬼畜', '逆強制', '女王樣', '精神控制', '精神崩潰', '爆精', '放尿', '懷孕', '噴奶', '角色扮演', '貓耳', '護士', '泳裝', '女僕', '裸體圍裙', '黑絲襪', '修女', '異世界', '異種族', '妖精', '魔物娘', '獸娘', '怪獸', '校園', '純愛', '窩邊草', 'NTR', '藥物', '奇幻', '性轉換', '百合', '扶他', '偽娘', '耽美'
    ];
