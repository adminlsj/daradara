...
class Cosplayjav
{
    ...
    public static $translations = [
        ...
        "Kurumi (胡桃)" => '胡桃',
        "Meltryllis (メルトリリス)" => '梅爾特莉莉絲',
        "Yamamoto Shuri (山本しゅり)" => '山本しゅり',
        ...
        "miwa_kasumi" => '三輪霞',
        "zenin_maki" => '禪院真希',
        "Miyazawa Chiharu (宮沢ちはる)" => '宮沢ちはる',
        "Kiruya Momochi (百地希留耶)" => '百地希留耶',
        "NieR Automata (ニエル オートマトン)" => '尼爾：自動人形',
        "Yorha No.2 Type B (ヨルハ2号B型)" => '寄葉二號B型',
        ...
        "fishnet_pantyhose" => '絲襪',
        "chinese_uniform" => '旗袍',
        "Final Fantasy (ファイナルファンタジー) Final Fantasy VII (ファイナルファンタジーVII)" => 'Final Fantasy系列',
        "fuyue_kotone" => '冬愛ことね',
        "Kuyano_Mayu" => '小谷野まゆ',
        "Aoyama_Mion" => '青山みおん',
        "legjob" => '腳交',
        "Keqing (genshin impact)" => '刻晴',
        "Misaki Suzuki [鈴木美咲]" => '鈴木美咲',
        "gochuumon wa usagi desu ka? (ご注文はうさぎですか？)" => '請問您今天要來點兔子嗎？',
        "hoto_cocoa" => '保登心愛',
        "kafuu_chino" => '香風智乃',
        "Tsujii Honoka (辻井ほのか)" => '辻井穗乃果',
        "Rider (ライダー)" => 'Rider',
        "shackles" => '手銬',
        "Tanaka Nene (田中ねね)" => '田中寧寧',
        "Ore_No_Boin" => '俺のボイン',
        "Dogma" => 'ドグマ',
        "choker" => '項圈',
        "Nagisa Yukino (凪沙ゆきの)" => '凪沙雪乃',
        "4M1G" => '4男1女',
        "Matou Sakura (間桐桜)" => '間桐櫻',
        "Aozora Hiyori (青空ひより)" => '青空日和',
        "fate series (フェイト・シリーズ)" => 'Fate系列',
        "fate stay/night" => 'Fate/stay night',
        "Wakamiya Hono (若宮穂乃)" => '若宮穂乃',
