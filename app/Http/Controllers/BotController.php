...
69079
        ...
        /* $ids = [];
        $videos = Video::where('genre', '國產素人')->where('cover', 'https://i.imgur.com/E6mSQA2.jpg')->where('created_at', '<=', '2023-03-04 01:38:47')->where('created_at', '>=', '2022-12-19 05:16:53')->orderBy('created_at', 'desc')->get();
        foreach ($videos as $video) {
