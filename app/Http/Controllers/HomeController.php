...
class HomeController extends Controller
{
    ...
    public function check()
    {
        ...
        curl_setopt($curl_connection, CURLOPT_REFERER, "https://api.bilibili.com/x/player/playurl?avid=61769681&cid=107207180&qn=0&type=mp4&otype=json&fnver=0&fnval=1&platform=html5&html5=1&high_quality=1");
